...
let GreeceDestination = new popularDestinations(
  "santorini",
  "Greece",
  "breathtaking views around every corner "
);
let ItalyDestination = new popularDestinations(
  "venice",
  "Italy",
  "City world-famous for its canals"
);

let buttons = document.querySelector(".btn");
buttons.addEventListener("click", showPopularDestinations);
